...
const scheduleData: Record<TabKey, { time: string; event: string; highlight?: boolean }[]> = {
  day1: [
    ...
    { time: "9:30 AM", event: "Doors open, check-in, name tags, swag" },
    { time: "10:00 AM", event: "Opening Ceremony", highlight: true },
    { time: "10:30 AM", event: "Team formation + person selection" },
    { time: "11:15 AM", event: "Lunch (60 min)" },
    { time: "12:15 PM", event: "Each team presents their person's problem (1 min each)", highlight: true },
    { time: "12:30 PM", event: "Planning session: sketch solution, choose tech stack" },
    { time: "1:00 PM", event: "Workshop: Getting Started (Git, APIs, deployment)" },
    { time: "1:30 PM", event: "Hacking begins", highlight: true },
  ...
  day2: [
    ...
    { time: "12:00 PM", event: "Lunch (Panera, 60 min)" },
